...
export const useChangeElements = () => {
    ...
    const [showValentinesMessage, setShowValentinesMessage] = useState(false);
    ...
    const handleButtonYes = () => {
        ...
        setTimeout(() => {
            setShowValentinesMessage(true); // Esto mostrará el mensaje 
          }, 3000);
    }

    return { handleButtonNo, handleButtonYes, textP, image, showValentinesMessage }
}